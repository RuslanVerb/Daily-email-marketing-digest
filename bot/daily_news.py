...
щоб той самий матеріал не публікувався повторно.
...
MAX_ITEMS = 8            # скільки новин максимум в одному дайджесті
SEEN_MAX_AGE_DAYS = 14    # скільки днів пам'ятати вже опубліковані посилання
